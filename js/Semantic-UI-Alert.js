...
$.uiAlert = function(options) {
  var setUI = $.extend({
    ...
    var ui_alert = 'ui-alert-content';
      ...
      setUI.bgcolors ='style="background-color: '+setUI.bgcolor+'; box-shadow: 0px 0px 9px 1px rgba(0,0,0,0.35); "';
      if(setUI.bgcolors === '') setUI.bgcolors ='style="background-color: ; box-shadow: 0px 0px 9px 1px rgba(0,0,0,0.35); "';
